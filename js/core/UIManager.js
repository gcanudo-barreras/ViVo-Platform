                    ...
                    <div class="help-section">
                        <p>Open source tool designed to standardize <i>in vivo</i> efficacy analysis, improve research reproducibility, and reduce animal usage.</p>
                            <p style="margin-top: 15px; font-size: 0.9em; color: #666;">
                                ...
                                <p style="font-size: 0.9em; color: #666;">All source code for the ViVo platform is available at <a href="https://github.com/gcanudo-barreras/ViVo-Platform" target="_blank" style="color: #a0a0a0;">github.com/gcanudo-barreras/ViVo-Platform</a> under the MIT License.
                                </p>
                            </p>
                        </p>
                    </div>
