            ...
            <div class="quality-badge" style="background: #007bff; width: fit-content; margin: 10px 0 0 10px;">${version}</div>
                ...
                <div class="modal-header">
                    ...
                    <div class="logo-container" style="margin-bottom: -25px; margin-top: -50px;">
                        <img src="https://github.com/gcanudo-barreras/ViVo-Platform/blob/0c0e6c2090dedfea8622965afdbef2accc8184e0/Assets/ViVo.png" alt="ViVo Logo" style="width: 212px; height: 212px;">
                    </div>
                    <div></div>
                </div>
                <div class="modal-body">
                    ...
                    <div class="about-section">
                        ...
                        <p style="margin-top: 15px; font-size: 0.9em; color: #666;">
                            This software is developed for research purposes. Please cite appropriately when used in scientific publications.<br>All source code for the ViVo platform is available at <a href="https://github.com/gcanudo-barreras/ViVo-Platform" target="_blank" style="color: #a0a0a0;">github.com/gcanudo-barreras/ViVo-Platform</a> under the MIT License.
                        </p></br>
                        </p>
                    </div>
                </div>
